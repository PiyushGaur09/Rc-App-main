...
//         const storedUpdateStatus = await AsyncStorage.getItem(`pdi_form_updated_${formId}`);
...
//       reflector_sticker_applied: data.reflector_sticker_applied?.toString() || '1',
...
//         // Mark form as updated in AsyncStorage
//         await AsyncStorage.setItem(`pdi_form_updated_${existingFormId}`, 'true');
...
//   // Download PDF Handler - CORRECTED ENDPOINT
...
//         }
//       } else {
//         const errorMsg = response.data?.message || 'PDF generation failed on server';
...
//           <Text style={styles.customerName}>{formData.customer_name || '—'}</Text>
...
//                     (text) => handleInputChange('tractor_starter_serial_no', text),
//                     'Starter serial'
//                   )}
//                   {isEditMode && (
//                     <TouchableOpacity
...
//         {/* Radio Sections - ALL RADIO BUTTONS INCLUDED */}
//         <View style={styles.radioSection}>
//           <Text style={styles.radioLabel}>Lights OK:</Text>
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('lights_ok', '1', 'YES')}
//             {renderRadioOption('lights_ok', '0', 'NO')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('nuts_ok', '1', 'YES')}
//             {renderRadioOption('nuts_ok', '0', 'NO')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('hydraulic_oil', '1', 'FULL')}
//             {renderRadioOption('hydraulic_oil', '0', 'HALF')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('all_nuts_sealed', '1', 'YES')}
//             {renderRadioOption('all_nuts_sealed', '0', 'NO')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('engine_oil_level', '1', 'FULL')}
//             {renderRadioOption('engine_oil_level', '0', 'HALF')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('coolant_level', '1', 'YES')}
//             {renderRadioOption('coolant_level', '0', 'NO')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('brake_fluid_level', '1', 'YES')}
//             {renderRadioOption('brake_fluid_level', '0', 'NO')}
//           </View>
//           {radioValues.brake_fluid_level === '0' && (
//             <View style={styles.singleRow}>
//               <Text style={styles.fieldLabel}>Remark for Brake Fluid Level</Text>
//               <LinearGradient
//                 colors={['#7E5EA9', '#20AEBC']}
//                 style={styles.inputGradient}>
//                 {renderInputField(
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('greasing_done', '1', 'YES')}
//             {renderRadioOption('greasing_done', '0', 'NO')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('paint_scratches', '1', 'YES')}
//             {renderRadioOption('paint_scratches', '0', 'NO')}
//           </View>
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('toolkit_available', '1', 'YES')}
//             {renderRadioOption('toolkit_available', '0', 'NO')}
//           </View>
//           {radioValues.toolkit_available === '0' && (
//             <View style={styles.singleRow}>
//               <Text style={styles.fieldLabel}>Remark for Toolkit Available</Text>
//               <LinearGradient
//                 colors={['#7E5EA9', '#20AEBC']}
//                 style={styles.inputGradient}>
//                 {renderInputField(
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('owner_manual_given', '1', 'YES')}
//             {renderRadioOption('owner_manual_given', '0', 'NO')}
//           </View>
//           {radioValues.owner_manual_given === '0' && (
//             <View style={styles.singleRow}>
//               <Text style={styles.fieldLabel}>Remark for Owner Manual Given</Text>
//               <LinearGradient
//                 colors={['#7E5EA9', '#20AEBC']}
//                 style={styles.inputGradient}>
//                 {renderInputField(
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('reflector_sticker_applied', '1', 'YES')}
//             {renderRadioOption('reflector_sticker_applied', '0', 'NO')}
//           </View>
//           {radioValues.reflector_sticker_applied === '0' && (
//             <View style={styles.singleRow}>
//               <Text style={styles.fieldLabel}>Remark for Reflector Sticker Applied</Text>
//               <LinearGradient
//                 colors={['#7E5EA9', '#20AEBC']}
//                 style={styles.inputGradient}>
//                 {renderInputField(
//                   formData.reflector_sticker_applied_no,
//                   (text) => handleInputChange('reflector_sticker_applied_no', text),
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('number_plate_fixed', '1', 'YES')}
//             {renderRadioOption('number_plate_fixed', '0', 'NO')}
//           </View>
//           {radioValues.number_plate_fixed === '0' && (
//             <View style={styles.singleRow}>
//               <Text style={styles.fieldLabel}>Remark for Number Plate Fixed</Text>
//               <LinearGradient
//                 colors={['#7E5EA9', '#20AEBC']}
//                 style={styles.inputGradient}>
//                 {renderInputField(
...
//           <View style={styles.radioOptionsContainer}>
//             {renderRadioOption('tractor_delivered', '1', 'YES')}
//             {renderRadioOption('tractor_delivered', '0', 'NO')}
//           </View>
//         </View>
...
//             <View style={styles.row}>
//               <View style={styles.halfWidthContainer}>
//                 <Text style={styles.fieldLabel}>Delivery Customer Name</Text>
//                 <LinearGradient
//                   colors={['#7E5EA9', '#20AEBC']}
//                   style={styles.inputGradient}>
//                   {renderInputField(
...
//                     (text) => handleInputChange('delivery_customer_father_name', text),
//                     'Father\'s name'
//                   )}
//                 </LinearGradient>
//               </View>
...
//                   (text) => handleInputChange('delivery_customer_address', text),
//                   'Delivery address'
//                 )}
//               </LinearGradient>
//             </View>
...
//             <View style={styles.singleRow}>
//               <Text style={styles.fieldLabel}>Delivery Contact</Text>
//               <LinearGradient
//                 colors={['#7E5EA9', '#20AEBC']}
//                 style={styles.inputGradient}>
//                 {renderInputField(
//                   formData.delivery_customer_contact,
//                   (text) => handleInputChange('delivery_customer_contact', text),
//                   'Delivery contact',
//                   'phone-pad'
//                 )}
//               </LinearGradient>
...
//                 onPress={() => isEditMode && setIsTermsAccepted(!isTermsAccepted)}
//                 disabled={!isEditMode || loading}
//               >
...
//             <>
//               <TouchableOpacity 
//                 style={[styles.submitButton, (loading || (radioValues.tractor_delivered === '1' && !isTermsAccepted)) && styles.disabledButton]} 
...
//   // Download PDF Handler - FIXED VERSION
//   const handleDownloadPDF = async () => {
//     if (!existingFormId) {
//       Alert.alert('Error', 'Form data not available');
//       return;
