...
//   // Image states - FIXED: Proper image state structure
...
//     // FIXED: Load existing images with proper structure
//     if (data.customer_photo) {
//       setCustomerPhoto({
//         uri: data.customer_photo,
//         type: 'image/jpeg',
...
//   // Image handling functions - FIXED: Proper image handling
...
//   const showImagePickerOptions = (setImageFunction, fieldName) => {
//     if (!isEditMode) return;
...
//             if (hasPermission) handleCamera(setImageFunction, fieldName);
//           } else if (buttonIndex === 2) handleImageLibrary(setImageFunction, fieldName);
//         }
//       );
//     } else {
//       Alert.alert(
...
//             }
//           },
//           { text: 'Choose from Library', onPress: () => handleImageLibrary(setImageFunction, fieldName) },
//         ],
//         { cancelable: true }
//       );
//     }
...
//   const handleCamera = (setImageFunction, fieldName) => {
//     launchCamera(
//       { 
//         mediaType: 'photo', 
//         quality: 0.8, 
...
//         if (response.error) {
//           Alert.alert('Error', `Failed to capture ${fieldName}`);
//           return;
//         }
...
//             name: asset.fileName || `${fieldName.toLowerCase()}_${Date.now()}.jpg`
//           });
//         }
//       }
//     );
...
//   const handleImageLibrary = (setImageFunction, fieldName) => {
//     launchImageLibrary({ 
//       mediaType: 'photo', 
//       quality: 0.8,
//       includeBase64: false 
...
//       if (response.didCancel) return;
//       if (response.error) {
//         Alert.alert('Error', `Failed to select ${fieldName}`);
//         return;
//       }
//       if (response.assets && response.assets.length > 0) {
//         const asset = response.assets[0];
...
//     if (customerPhoto && customerPhoto.uri) {
...
//     if (customerSignature && customerSignature.uri) {
...
//     if (managerSignature && managerSignature.uri) {
...
//   // Render Input Field based on edit mode
...
//   // Render Image Box with Label
//   const renderImageBox = (image, setImageFunction, label, boxStyle) => (
//     <View style={styles.imageContainer}>
//       <Text style={styles.imageLabel}>{label}</Text>
//       <TouchableOpacity 
//         style={[boxStyle, !image && styles.emptyImageBox]} 
//         onPress={() => showImagePickerOptions(setImageFunction, label)}
//         disabled={!isEditMode || loading}
//       >
//         {image ? (
//           <Image 
...
//         ) : (
//           <>
//             {label === 'Customer Photo' && <Icon name="photo-camera" size={35} color="#666" />}
//             <Text style={styles.photoSignatureText}>
//               {label === 'Customer Photo' ? 'Tap to add photo' : 'Tap to add signature'}
//             </Text>
//           </>
//         )}
//       </TouchableOpacity>
...
//         {/* Form Fields - FIXED: Single row layout with labels */}
...
//           {renderImageBox(customerSignature, setCustomerSignature, 'Customer Signature', styles.photoSignatureBox1)}
//           {renderImageBox(managerSignature, setManagerSignature, 'Manager Signature', styles.photoSignatureBox1)}
//         </View>

//         {/* Action Buttons */}
//         <View style={styles.buttonContainer}>
//           {/* Edit Button - Only show when status is 'edited' and not in edit mode */}
...
//           {/* Update and Cancel Buttons - Only show in edit mode */}
//           {isEditMode && (
//             <>
//               <TouchableOpacity 
...
//   // Image handling functions - FIXED: Updated to handle both remote URLs and local files
//   const requestCameraPermissionForImage = async () => {
//     if (Platform.OS === 'android') {
//       try {
//         const granted = await PermissionsAndroid.request(
...
//   // Show image source options (camera or gallery) - FIXED: Similar to Forminternalpage
...
//     // FIXED: Image handling - Append images only if they are local URIs (newly selected)
...
//   // Render Image Box with Label - FIXED: Updated to match Forminternalpage style
...
//         {/* Signatures Section - FIXED: Added proper signature handling */}
...
//     color: '#7E5EA9',
//   },
//   // Photo Section Styles - FIXED: Added from Forminternalpage
//   photoSection: {
//     alignItems: 'center',
//     marginTop: 20,
//   },
...
//     // Used for signatures
//   },
//   // Signature Section Styles - FIXED: Added from Forminternalpage
//   sectionTitle: {
//     fontSize: 18,
//     fontWeight: 'bold',
//     marginBottom: 10,
...
//         const storedUpdateStatus = await AsyncStorage.getItem(`rc_form_updated_${formId}`);
...
//         await AsyncStorage.setItem(`rc_form_updated_${existingFormId}`, 'true');
