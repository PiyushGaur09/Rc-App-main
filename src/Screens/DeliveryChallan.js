  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const url = isEditMode
        ? 'https://makroomotors.com/makroo-panel/public/api/v1/delivery-challan/form/update'
        : 'https://makroomotors.com/makroo-panel/public/api/v1/delivery-challan/form/save';
