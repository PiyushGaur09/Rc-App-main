...
const Customerpaymentdetails = ({ navigation, route }) => {
  ...
  const handleEditPayment = (payment) => {
    if (payment.status === 'edited') {
      ...
      Alert.alert(
        'Cannot Edit', 
        `This payment has status "${getStatusText(payment.status)}" and cannot be edited. Only payments with "Edited" status can be modified.`
      );
    }
  };
  ...
  const totalPayments = payments.reduce((sum, payment) => sum + parseFloat(payment.opening_balance || 0), 0);
  const totalAmountPaid = payments.reduce((sum, payment) => sum + parseFloat(payment.total_paid || 0), 0);
          ...
          <View style={styles.itemContent}>
            ...
            <View style={styles.statusContainer}>
              <View style={[styles.statusBadge, { backgroundColor: getStatusColor(item.status) }]}>
                <Icon name={getStatusIcon(item.status)} size={moderateScale(14)} color="#FFF" />
            ...
            <View style={styles.itemHeader}>
              <View style={styles.customerInfo}>
                ...
                <Text style={styles.customerFather}>{item.father_name || 'N/A'}</Text>
              </View>
            ...
            <View style={styles.paymentSummary}>
              <View style={styles.amountRow}>
                <View style={styles.amountItem}>
                  ...
                  <Text style={styles.amountValue}>{formatCurrency(item.opening_balance)}</Text>
                </View>
                ...
                <View style={styles.amountItem}>
                  ...
                  <Text style={[styles.amountValue, remaining > 0 ? styles.remainingAmount : styles.fullPaidAmount]}>
              ...
              >
                ...
                >
                  {generatingPdf ? (
                    ...
                    <>
                      <Icon name="download" size={moderateScale(16)} color="#FFF" />
            ...
            <View style={styles.statusFlowInfo}>
              <Text style={styles.statusFlowTitle}>Status Flow:</Text>
              <View style={styles.statusFlowSteps}>
                <View style={styles.statusStep}>
                  <View style={[styles.statusStepDot, 
                    item.status === 'pending' || item.status === 'edited' || item.status === 'approved' || item.status === 'rejected' 
                      ? styles.activeStep 
                      : styles.inactiveStep
                  ]} />
                ...
                <View style={styles.statusStep}>
                  <View style={[styles.statusStepDot, 
                    item.status === 'edited' || item.status === 'approved' || item.status === 'rejected' 
                      ? styles.activeStep 
                      : styles.inactiveStep
                  ]} />
                  <Text style={styles.statusStepText}>Edited</Text>
                </View>
                <View style={styles.statusStep}>
                  <View style={[styles.statusStepDot, 
              ...
              <View style={styles.summaryGrid}>
                <View style={styles.summaryItem}>
                  <View style={styles.summaryIconContainer}>
                    <Icon name="dollar-sign" size={moderateScale(20)} color="#7E5EA9" />
                  </View>
                  <Text style={styles.summaryValue}>{formatCurrency(totalPayments)}</Text>
                  <Text style={styles.summaryLabel}>Total Amount Collected</Text>
                </View>
                
                <View style={styles.summaryItem}>
                  <View style={[styles.summaryIconContainer, styles.paidIcon]}>
                    <Icon name="check-circle" size={moderateScale(20)} color="#4CAF50" />
                  </View>
                  <Text style={styles.summaryValue}>{formatCurrency(totalAmountPaid)}</Text>
                  <Text style={styles.summaryLabel}>Amount Paid</Text>
                </View>
                
                <View style={styles.summaryItem}>
                  <View style={[styles.summaryIconContainer, styles.remainingIcon]}>
                    <Icon name="clock" size={moderateScale(20)} color="#FF6B6B" />
                  </View>
                ...
                <View style={styles.summaryItem}>
                  <View style={[styles.summaryIconContainer, styles.customerIcon]}>
                    <Icon name="users" size={moderateScale(20)} color="#20AEBC" />
                  </View>
        ...
        <View style={styles.searchSection}>
          ...
          <View style={styles.searchContainer}>
            <View style={styles.searchInputContainer}>
              <Icon name="search" size={moderateScale(20)} color="#7E5EA9" style={styles.searchIcon} />
              <TextInput
        ...
        <View style={styles.listSection}>
          ...
          {loading ? (
            ...
            <View style={styles.emptyState}>
              ...
              >
                <Icon name="file-text" size={moderateScale(70)} color="#7E5EA9" />
